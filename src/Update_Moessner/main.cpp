...
void UsageHelp()
{
	cout << "--> Update Lozenge lattice simulations program" << endl << endl;

	cout << "    Usage: ./Update_Moessner_Lab [folder] [input file]" << endl << endl;
...
//		ExportObject(params,dummyString.c_str());
//
//		scriptFile << "nice -19 ./" << input.execName << " " << vtFolder[iii] << "/Obj_conf.odat" << " " << vtFolder[iii] << " > ${PWD}/" << outFolder << "out_log.txt &" <<  endl;
//		++dummyCounter;
//		if(dummyCounter==input.numProc&&input.numProc!=input.VtN)
//		{
//			scriptFile << "wait" << endl;
//			dummyCounter = 0;
//			scriptFile << "echo ' ---> Finished " << iii+1 << " of " << input.VtN << "'" << endl;
//		}
//	}
//	scriptFile << "wait" << endl;
